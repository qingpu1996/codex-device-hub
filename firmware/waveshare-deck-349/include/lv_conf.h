...
#define LV_USE_ASSERT_NULL          DECK_VERBOSE_LOGS   /**< Check if the parameter is NULL. (Very fast, recommended) */
#define LV_USE_ASSERT_MALLOC        DECK_VERBOSE_LOGS   /**< Checks is the memory is successfully allocated or no. (Very fast, recommended) */
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(codex_deck_cjk_16)
